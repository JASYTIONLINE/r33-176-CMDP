> **Authoritative source.** Edit **`sops/batteries.md`**. Regenerate **`sops/10.14.3-sop-battery-program.html`** by running `python -m scripts.sops._md_batteries_to_html` from the repository root.
