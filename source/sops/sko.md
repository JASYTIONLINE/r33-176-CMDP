> **Authoritative source.** Edit **`sops/sko.md`**. Regenerate **`sops/10.11.1-sop-tool-room.html`** by running `python -m scripts.sops._md_sko_to_html` from the repository root.
...
- [Army Publishing Directorate (APD)](https://armypubs.army.mil/) (official Department of the Army publications and forms retrieval)
- [United States Army](https://www.army.mil/) (official Army public portal for organization-level guidance and announcements when command policy supplements publications)
