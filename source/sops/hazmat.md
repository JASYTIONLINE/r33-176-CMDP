> **Authoritative source.** Edit **`sops/hazmat.md`**. Regenerate **`sops/10.4.3-sop-environmental.html`** by running `python -m scripts.sops._md_hazmat_to_html` from the repository root.
