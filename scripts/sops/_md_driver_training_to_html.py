...
from scripts.paths import resolve_drivetrain_md, sop_publish_dir

_PUB = sop_publish_dir()

MD_PATH = resolve_drivetrain_md()
OUT_FRAG = _PUB / "_driver_training_body.frag.html"
OUT_PAGE = _PUB / "10.10.1-sop-driver-training.html"
