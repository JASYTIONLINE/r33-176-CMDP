> **Authoritative source.** Edit **`sops/arms-room.md`**. Regenerate **`sops/10.15.1-sop-arms-room.html`** by running `python -m scripts.sops._md_arms_room_to_html` from the repository root.
