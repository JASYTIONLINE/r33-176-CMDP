> **Authoritative source.** Edit **`sops/cbrn.md`**. Regenerate **`sops/10.16.2-sop-cbrn.html`** by running `python -m scripts.sops._md_cbrn_to_html` from the repository root.
