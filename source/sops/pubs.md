> **Authoritative source.** Edit **`sops/pubs.md`**. Regenerate **`sops/10.18.1-sop-publications.html`** by running `python -m scripts.sops._md_pubs_to_html` from the repository root.
...
- [Army Publishing Directorate (APD) portal](https://armypubs.army.mil/) (official publications, forms, and publications-program ordering and account resources)
...
- Use official Army Publishing Directorate resources for publications accounts and ordering: [Army Publishing Directorate (APD) portal](https://armypubs.army.mil/).
